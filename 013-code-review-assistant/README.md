# 013 - PR Code Review Bot

Automatically review pull requests for code quality, security issues, style violations, and provide actionable feedback.
...
| `skills/code-reviewer/SKILL.md` | AI skill definition |
