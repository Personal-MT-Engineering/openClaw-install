# 017 - Dependency Version Monitor

Monitor dependencies for updates and security vulnerabilities, create PRs for safe upgrades.
...
| `skills/dependency-updater/SKILL.md` | AI skill definition |
