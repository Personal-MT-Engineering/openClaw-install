# 050 - Study Group Coordinator

Coordinate study groups with scheduling, topic assignments, resource sharing, and session summaries.
...
| `skills/study-coordinator/SKILL.md` | AI skill definition |
