# 015 - Bug Priority Assignment Bot

Automatically triage new bug reports, assign priority levels, suggest assignees, and track resolution.
...
| `skills/bug-triage/SKILL.md` | AI skill definition |
