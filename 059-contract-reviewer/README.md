# 059 - Contract Clause Risk Analyzer

Review contracts for risky clauses, missing protections, and non-standard terms.
...
| `skills/contract-reviewer/SKILL.md` | AI skill definition |
