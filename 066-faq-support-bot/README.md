# 066 - Multi-Channel FAQ Bot

Answer customer questions across multiple channels using a centralized knowledge base with learning capability.
...
| `skills/faq-bot/SKILL.md` | AI skill definition |
