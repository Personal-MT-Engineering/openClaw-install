# 055 - Budget Variance Tracker

Track budget vs actual spending, alert on variances, and forecast future spending trends.
...
| `skills/budget-tracker/SKILL.md` | AI skill definition |
