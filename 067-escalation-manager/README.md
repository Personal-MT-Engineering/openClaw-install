# 067 - SLA Escalation Manager

Monitor ticket SLAs, escalate overdue items, notify managers, and track resolution metrics.
...
| `skills/escalation-manager/SKILL.md` | AI skill definition |
