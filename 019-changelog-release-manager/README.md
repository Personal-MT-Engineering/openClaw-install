# 019 - Changelog & Release Manager

Generate changelogs from commits, manage semantic versioning, create GitHub releases, and notify stakeholders.
...
## Key Integrations
GitHub, Slack/Discord, Exec, Cron
...
| `skills/release-manager/SKILL.md` | AI skill definition |
