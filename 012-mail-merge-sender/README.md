# 012 - Personalized Bulk Email Sender

Create and send personalized bulk emails using templates and recipient data from CSV files.
...
| `skills/mail-merge/SKILL.md` | AI skill definition |
