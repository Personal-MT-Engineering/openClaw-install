# 010 - Visitor Check-In & Notification

Provide a web-based visitor check-in kiosk that notifies hosts and logs all visits.
...
| `skills/visitor-checkin/SKILL.md` | AI skill definition |
