# 090 - Podcast Production Assistant

Assist with podcast production including transcription, show notes, timestamps, and distribution.
...
| `skills/podcast-assistant/SKILL.md` | AI skill definition |
