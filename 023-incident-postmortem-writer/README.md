# 023 - Postmortem Template Generator

Generate structured incident postmortem documents from Slack threads and incident timelines.
...
| `skills/postmortem-writer/SKILL.md` | AI skill definition |
