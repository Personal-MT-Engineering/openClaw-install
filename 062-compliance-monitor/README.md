# 062 - Regulatory Change Monitor

Monitor regulatory websites for changes, assess impact on business operations, and distribute alerts.
...
| `skills/compliance-monitor/SKILL.md` | AI skill definition |
