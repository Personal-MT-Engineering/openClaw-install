# 045 - Automated Quiz Generator

Generate quizzes from study material with multiple question types, auto-grading, and performance analytics.
...
| `skills/quiz-generator/SKILL.md` | AI skill definition |
