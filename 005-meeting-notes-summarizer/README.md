# 005 - Meeting Transcript Summarizer

Transcribe meeting recordings using Whisper, summarize key points, extract action items, and distribute notes.
...
| `skills/meeting-summarizer/SKILL.md` | AI skill definition |
