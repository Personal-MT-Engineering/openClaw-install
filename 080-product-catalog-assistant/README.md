# 080 - Product Q&A & Recommendation Bot

Answer product questions and provide personalized recommendations based on customer needs.
...
| `skills/catalog-assistant/SKILL.md` | AI skill definition |
