# 006 - Employee Onboarding Automation

Guide new employees through onboarding steps, collect required documents, assign training modules, and track completion.
...
| `skills/hr-onboarding/SKILL.md` | AI skill definition |
