# 004 - Receipt Scanning Expense Tracker

Scan receipts from photos, extract amounts and categories, track expenses, and generate monthly reports.
...
| `skills/expense-tracker/SKILL.md` | AI skill definition |
