# 064 - Intellectual Property Tracker

Track patents, trademarks, and copyrights with renewal dates, filing status, and jurisdiction monitoring.
...
| `skills/ip-tracker/SKILL.md` | AI skill definition |
