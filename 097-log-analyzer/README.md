# 097 - Application Log Anomaly Detector

Analyze application logs for anomalies, pattern-match errors, and provide root cause suggestions.
...
| `skills/log-analyzer/SKILL.md` | AI skill definition |
