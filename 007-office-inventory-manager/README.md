# 007 - Office Supply Inventory Tracker

Track office supply levels, auto-generate purchase orders when stock is low, and manage vendor relationships via browser.
...
| `skills/inventory-manager/SKILL.md` | AI skill definition |
