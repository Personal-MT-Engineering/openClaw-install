# 025 - Patient Appointment Scheduler

Schedule patient appointments, send reminders, handle cancellations, and manage doctor availability.
...
| `skills/appointment-scheduler/SKILL.md` | AI skill definition |
