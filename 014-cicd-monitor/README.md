# 014 - CI/CD Pipeline Monitor

Monitor CI/CD pipelines, alert on failures, analyze build logs, and suggest fixes.
...
## Key Integrations
GitHub, Webhooks, Slack/Discord, Cron
...
| `skills/cicd-monitor/SKILL.md` | AI skill definition |
