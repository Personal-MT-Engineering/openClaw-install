# 100 - Backup Integrity Verifier

Verify backup integrity, test restoration, monitor backup schedules, and alert on failures.
...
| `skills/backup-verifier/SKILL.md` | AI skill definition |
