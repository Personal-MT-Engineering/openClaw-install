# 008 - Travel Request Approval Workflow

Manage travel request submissions, route approvals to managers, book travel via browser, and track budgets.
...
| `skills/travel-approval/SKILL.md` | AI skill definition |
