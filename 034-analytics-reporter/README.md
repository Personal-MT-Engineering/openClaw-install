# 034 - Social Analytics Reporter

Collect social media analytics, generate performance reports, and provide actionable insights.
...
| `skills/analytics-reporter/SKILL.md` | AI skill definition |
