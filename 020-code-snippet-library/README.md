# 020 - Team Code Snippet Library

Maintain a searchable library of reusable code snippets shared across the team.
...
## Key Integrations
Slack/Discord, File system, Obsidian
...
| `skills/snippet-library/SKILL.md` | AI skill definition |
