# 074 - Inventory Level Monitor

Monitor inventory levels across warehouses, predict stockouts, and trigger reorder workflows.
...
| `skills/inventory-monitor/SKILL.md` | AI skill definition |
