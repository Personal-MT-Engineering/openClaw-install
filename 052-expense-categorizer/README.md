# 052 - Bank Transaction Categorizer

Categorize bank transactions automatically, detect anomalies, and generate spending reports.
...
| `skills/expense-categorizer/SKILL.md` | AI skill definition |
