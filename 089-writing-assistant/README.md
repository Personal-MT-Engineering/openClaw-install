# 089 - Long-Form Writing Editor

Help with long-form writing including structure, style, grammar, and consistency checks.
...
| `skills/writing-assistant/SKILL.md` | AI skill definition |
