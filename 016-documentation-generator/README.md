# 016 - API & Code Docs Generator

Generate and update API documentation, code docs, and architecture diagrams from source code.
...
## Key Integrations
GitHub, File system, Slack

## Extra Dependencies
gh CLI, typedoc/pydoc
...
| `skills/docs-generator/SKILL.md` | AI skill definition |
