# 079 - Sales Pipeline Tracker

Track deals through sales stages, forecast revenue, and provide coaching insights.
...
| `skills/pipeline-tracker/SKILL.md` | AI skill definition |
