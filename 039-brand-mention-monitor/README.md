# 039 - Brand Mention Sentiment Monitor

Monitor brand mentions across the web, analyze sentiment, and alert on negative mentions requiring response.
...
## Key Integrations
Browser, blogwatcher, Cron, Slack
...
| `skills/brand-monitor/SKILL.md` | AI skill definition |
