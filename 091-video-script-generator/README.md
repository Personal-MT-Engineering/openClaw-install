# 091 - Video Script & Storyboard Gen

Generate video scripts with scene descriptions, dialogue, and storyboard suggestions.
...
## Key Integrations
Slack/Telegram, Image Gen

## Extra Dependencies
openai-image-gen skill (optional)
...
| `skills/video-script-gen/SKILL.md` | AI skill definition |
