# 051 - Invoice Generation & Tracking

Generate professional invoices, track payment status, send reminders, and generate accounts receivable reports.
...
## Key Integrations
Slack/Telegram, Gmail (gog), nano-pdf, Cron
...
| `skills/invoice-manager/SKILL.md` | AI skill definition |
