# 026 - Pre-Visit Intake Form Bot

Collect patient information before visits including medical history, current medications, allergies, and insurance details.
...
| `skills/patient-intake/SKILL.md` | AI skill definition |
