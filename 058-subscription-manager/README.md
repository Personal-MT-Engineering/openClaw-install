# 058 - SaaS Subscription Tracker

Track SaaS subscriptions, monitor renewal dates, analyze spending, and suggest optimizations.
...
| `skills/subscription-manager/SKILL.md` | AI skill definition |
