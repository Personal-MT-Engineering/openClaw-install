# 098 - SSL Certificate Expiry Monitor

Monitor SSL certificate expiration dates, alert before expiry, and optionally auto-renew with certbot.
...
| `skills/ssl-monitor/SKILL.md` | AI skill definition |
