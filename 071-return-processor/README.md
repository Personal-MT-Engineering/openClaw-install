# 071 - Return & Refund Processor

Handle return requests, validate eligibility, generate return labels, and process refunds.
...
## Key Integrations
WhatsApp/Telegram, Browser, Gmail (gog)
...
| `skills/return-processor/SKILL.md` | AI skill definition |
