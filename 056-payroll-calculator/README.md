# 056 - Payroll Calculation Assistant

Calculate payroll including deductions, taxes, benefits, and generate pay stubs.
...
| `skills/payroll-calculator/SKILL.md` | AI skill definition |
