# 002 - Smart Meeting Scheduler

Intelligently schedule meetings by checking availability, suggesting optimal times, and sending calendar invites via browser automation.
...
## Key Integrations
WhatsApp/Telegram, Browser, Cron
...
| `skills/meeting-scheduler/SKILL.md` | AI skill definition |
