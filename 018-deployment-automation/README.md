# 018 - Chat-Driven Deployment

Deploy applications through chat commands with approval workflows, rollback support, and status tracking.
...
| `skills/deploy-bot/SKILL.md` | AI skill definition |
