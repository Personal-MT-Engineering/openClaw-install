# 069 - Knowledge Base Auto-Updater

Automatically update knowledge base articles based on resolved tickets and product changes.
...
| `skills/kb-updater/SKILL.md` | AI skill definition |
