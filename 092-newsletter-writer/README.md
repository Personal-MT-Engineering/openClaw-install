# 092 - Newsletter Content Curator

Curate industry news, write newsletter content, and manage subscriber distribution.
...
## Key Integrations
Browser, blogwatcher, Gmail (gog), Cron
...
| `skills/newsletter-writer/SKILL.md` | AI skill definition |
