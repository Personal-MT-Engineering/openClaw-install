# 027 - Lab Result Summarizer

Summarize lab reports and medical documents, highlight abnormal values, and explain results in plain language.
...
| `skills/medical-summarizer/SKILL.md` | AI skill definition |
