# 088 - Reading List & Book Summary

Manage a reading list, track progress, provide book summaries, and suggest new reads.
...
## Key Integrations
Telegram/WhatsApp, Cron, Browser
...
| `skills/reading-manager/SKILL.md` | AI skill definition |
