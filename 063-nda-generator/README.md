# 063 - NDA & Legal Document Generator

Generate NDAs and common legal documents from templates with customizable terms.
...
## Key Integrations
Slack/Telegram, nano-pdf, Gmail (gog)
...
| `skills/nda-generator/SKILL.md` | AI skill definition |
