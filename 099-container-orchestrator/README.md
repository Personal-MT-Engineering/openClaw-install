# 099 - Docker Container Lifecycle Mgr

Manage Docker container lifecycle, monitor resource usage, and handle scaling decisions.
...
| `skills/container-manager/SKILL.md` | AI skill definition |
