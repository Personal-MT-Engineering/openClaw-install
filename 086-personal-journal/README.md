# 086 - Daily Journaling Assistant

Provide daily journaling prompts, help process thoughts, and track mood patterns over time.
...
## Key Integrations
WhatsApp/Telegram, Cron, Obsidian
...
| `skills/journal-assistant/SKILL.md` | AI skill definition |
