# 021 - Natural Language DB Query

Translate natural language questions into SQL queries, execute them safely, and format results.
...
| `skills/db-query-assistant/SKILL.md` | AI skill definition |
