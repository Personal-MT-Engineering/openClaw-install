# 095 - Server Health Monitor

Monitor server health metrics, alert on anomalies, and provide diagnostic suggestions.
...
| `skills/server-monitor/SKILL.md` | AI skill definition |
