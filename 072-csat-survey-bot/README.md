# 072 - CSAT & NPS Survey Bot

Send customer satisfaction surveys after interactions, collect responses, and generate CSAT/NPS reports.
...
| `skills/csat-bot/SKILL.md` | AI skill definition |
