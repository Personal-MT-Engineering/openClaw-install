# 057 - Crypto Portfolio Tracker

Track cryptocurrency portfolio values, monitor price alerts, and generate performance reports.
...
## Key Integrations
Browser, Cron, Telegram/WhatsApp
...
| `skills/crypto-tracker/SKILL.md` | AI skill definition |
