# 047 - Citation & Bibliography Manager

Manage research citations, format bibliographies in multiple styles, and check for missing references.
...
| `skills/citation-manager/SKILL.md` | AI skill definition |
