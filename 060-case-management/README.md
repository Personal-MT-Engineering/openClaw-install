# 060 - Legal Case & Deadline Tracker

Track legal cases, manage deadlines, document filings, and generate status reports.
...
| `skills/case-manager/SKILL.md` | AI skill definition |
