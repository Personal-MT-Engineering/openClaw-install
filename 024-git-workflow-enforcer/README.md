# 024 - Git Convention Enforcer

Enforce git conventions including commit message format, branch naming, PR templates, and review requirements.
...
| `skills/git-enforcer/SKILL.md` | AI skill definition |
