# 075 - Competitor Price Monitor

Monitor competitor product prices, detect changes, and generate pricing intelligence reports.
...
| `skills/price-monitor/SKILL.md` | AI skill definition |
