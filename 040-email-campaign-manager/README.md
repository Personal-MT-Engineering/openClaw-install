# 040 - Email Marketing Campaign Manager

Create, send, and track email marketing campaigns with segmentation and analytics.
...
| `skills/email-campaign/SKILL.md` | AI skill definition |
