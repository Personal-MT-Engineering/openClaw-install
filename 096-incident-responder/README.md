# 096 - Incident Response Runbook

Execute incident response runbooks, coordinate response teams, and maintain incident timelines.
...
| `skills/incident-responder/SKILL.md` | AI skill definition |
